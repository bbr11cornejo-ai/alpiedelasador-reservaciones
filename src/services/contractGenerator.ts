...
export const generateContract = (booking: Booking): string => {
  try {
    ...
    const clauses = [
      ...
      '4.- 15 MINUTOS DE TOLERANCIA MÁXIMA PARA DESALOJAR LA QUINTA, PASADAS DE ESE TÉRMINO SE COBRARÁ MONTO DE $500 SIN OTORGAR TIEMPO ADICIONAL, PUDIENDO ACCESAR PERSONAL DE LA QUINTA PARA EL RETIRO DE MOBILIARIO',
      '5.- COSTO DE HORA EXTRA $400 PESOS, NOS RESERVAMOS DERECHO DE OTORGAR HORA EXTRA SEGÚN COMPROMISO PARA ESE DÍA',
      '6.- CUALQUIER ELEMENTO, MOBILIARIO COMO SILLAS, MESAS, SANITARIOS, BOCINA O CUALQUIER OTRO MOBILIARIO QUE SUFRA ALGÚN DAÑO POR PARTE DEL EVENTO O LOS INVITADOS ES RESPONSABILIDAD DEL CLIENTE, SE COBRARÁ LO QUE SE REQUIERA SEGÚN EL ACCIDENTE SUSCITADO DENTRO DE LAS INSTALACIONES CONTRATADAS DURANTE SU EVENTO.',
      '7.- USO DE ALBERCA SUJETO A TRAJE DE BAÑO, PROHIBIDO INGRESAR A ALBERCA CON MEZCLILLA, ZAPATOS, ETC YA QUE DAÑAN LA BOMBA DE ALBERCA',
      '8.- NO NOS HACEMOS RESPONSABLES DE NINGÚN TIPO DE ACCIDENTE SUSCITADO EN LAS INSTALACIONES ACEPTANDO EL CLIENTE CUALQUIER RESPONSABILIDAD CIVIL, PENAL O DE CUALQUIER ÍNDOLE JUDICIAL QUE LLEGARA A SUCEDER DENTRO DEL HORARIO Y DÍA CORRESPONDIENTE A SU CONTRATO',
      '9.- NO NOS HACEMOS RESPONSABLES DE OBJETOS OLVIDADOS EN LAS INSTALACIONES DESPUÉS DE RECIBIDO EL MISMO.',
      '10.- SE COBRARÁ LA CANTIDAD DE 500 PESOS EN EL SUPUESTO DE QUE LOS MANTELES SUFRAN DETERIOROS IRREVERSIBLES POR ACCIÓN O CIRCUNSTANCIA QUE IMPIDAN SU USO NUEVAMENTE COMO DERRAME DE SALSAS, PAPEL DE PIÑATA MOJADO O QUEMADURAS DE CIGARRO O CUALQUIER CIRCUNSTANCIA QUE DETERIORE IRREVERSIBLEMENTE EL MANTEL',
      '11.- NO SE PERMITE EL USO DE PAPEL CREPE NI PAPEL CHINA YA QUE DEJAN MARCAS EN EL SUELO',
      '12.- PARA MÚSICA EN VIVO SOLAMENTE SE ACEPTA TECLADISTA CON CANTANTE, 1 O 2 PERSONAS CON GUITARRA O ACORDEÓN TIPO FARA-FARA, MARIACHI (NO SE ACEPTAN GRUPOS CON BATERÍA, TUBA, ETC)',
      '13.- SE LES PIDE MODERAR EL SONIDO YA QUE EL ESPACIO ES COMPACTO Y NOS ENCONTRAMOS EN ZONA RESIDENCIAL',
      '14.- PARA EL ÁREA DE ESTACIONAMIENTO SE PUEDE TOMAR TODO ALREDEDOR DE LA ESCUELA, SE LES PIDE RESPETAR LOS LUGARES FRENTE A LAS CASAS Y COCHERAS',
      '15.- SE LES SOLICITA QUE SUS INVITADOS SE ENCUENTREN DENTRO DE LAS INSTALACIONES Y NO EN ÁREAS EXTERNAS COMO BANQUETAS, CALLE, ETC DURANTE EL TIEMPO DE SU EVENTO POR CUESTIONES MUNICIPALES',
      '16.- NO NOS ES POSIBLE EXTENDER EL HORARIO DESPUÉS DE LAS 12 DE LA NOCHE YA QUE NOS ENCONTRAMOS EN ZONA RESIDENCIAL'
    ];
